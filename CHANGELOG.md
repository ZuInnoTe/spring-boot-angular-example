...
## Unreleased
* Backend: Update to [Spring Boot 4.0.1](https://spring.io/blog/2025/12/18/spring-boot-4-0-1-available-now), Hibernate 7.2.0.Final, Spring Modulith 2.0.1, BouncyCastle 1.83, Gradle Plugin: CycloneDX 3.1.0, Spotless 8.2.1
