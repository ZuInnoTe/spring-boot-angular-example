...
* Backend: Update to [Gradle 9.6.0](https://docs.gradle.org/9.6.0/release-notes.html)
* Backend: Update to [Spring Boot 4.1.0](https://spring.io/blog/2026/06/10/spring-boot-4), Hibernate 7.2.4.Final, Spring Modulith 2.1.0, BouncyCastle 1.84, Hibernate JCache 7.4.2.Final, OWASP HTML Sanitizer: 20260313.1, EHCache 3.12.0, Gradle Plugin: CycloneDX 3.2.4, Spotless 8.7.0, version-plugins 0.54.0
...
* Frontend: Update to cyclonedx 5.0.0,eslint 10.5.0, jsdom 29.1.1, prettier 3.8.4
