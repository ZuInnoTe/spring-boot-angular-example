...
## Unreleased
* Backend: Update to [Spring Boot 4.0.2](https://spring.io/blog/2026/01/22/spring-boot-4-0-2-available-now, Hibernate 7.2.0.Final, Spring Modulith 2.0.1, BouncyCastle 1.83, OWASP HTML Sanitizer: 20260102.1, Gradle Plugin: CycloneDX 3.1.0, Spotless 8.2.1
