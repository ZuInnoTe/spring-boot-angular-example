...
## Unreleased
* CI/CD: Added [forgejo](.forgejo/workflows/build.yml) CI/CD pipeline for running job on codeberg.org
* Backend: Update to [Gradle 9.3.1](https://docs.gradle.org/9.3.1/release-notes.html)
