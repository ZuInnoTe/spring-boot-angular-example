...
public class SecurityConfigurationSaml {
    private static final String SAML_ROLE_ATTRIBUTE_NAME =
            "groups"; // Where to find in the SAML Assertation Attributes the role memberships of
    // the user
    private static final String SAML_ROLE_ATTRIBUTE_SEPARATOR =
            ","; // If the role attribute contains multiple roles then you need to define how they
    // separated. It is ignored if there is no separator
                    ...
                    for (Assertion assertion : responseToken.getResponse().getAssertions()) {
                        for (AttributeStatement attributeStatement :
                            ...
                            for (Attribute attribute : attributeStatement.getAttributes()) {
                                if ("Affiliation".equals(attribute.getName())) {
